    ...
    return (
        <div className="border border-zinc-200 dark:border-zinc-700 rounded-xl overflow-hidden bg-white dark:bg-zinc-900 transition-all hover:border-zinc-400 dark:hover:border-zinc-600 mb-2">
            ...
            >
                ...
                <div className="flex items-center gap-3">
                    <Link
                        href={`/curator/admin/universities/${university.id}/settings`}
                        onClick={(e) => e.stopPropagation()}
                        className="text-xs px-2 py-1 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 rounded border border-zinc-300 dark:border-zinc-700 text-zinc-600 dark:text-zinc-400 transition"
                        title="Настройки ВУЗа и задач"
                    >
                        Настройки
                    </Link>
